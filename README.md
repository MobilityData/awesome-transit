...
- [TNExT](https://github.com/ODOT-PTS/TNExT) - Transit Network Explorer Tool (TNExT) is a web-based software tool developed for the visualization, analysis, and reporting of regional and statewide transit networks in the state of Oregon.
- ITP's [TransitExplorer tool](https://www.itpworld.net/news-and-views/2021/transitexplorer-interactively-understanding-public-transport-networks-using-gtfs) is a visualisation tool for frequency-based GTFS feeds that uses OpenStreetMap street links to analyse network capacity, bottlenecks, routing etc., and draw interactive 'spider maps' for whole networks or from specific corridors. 
