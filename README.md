...
- [gtfs-lib](https://github.com/conveyal/gtfs-lib/) - Conveyal's successor to gtfs-validator, fast and attempts to fully complete validation.
...
- [Web GTFS Meta-Validator](http://gtfsvalidator.omnimodal.io) - A web-based GTFS validator that runs both [feedValidator](https://github.com/google/transitfeed/wiki/FeedValidator) and [gtfs-validator](https://github.com/conveyal/gtfs-validator) on uploaded GTFS files.
...
- [Web gtfs-realtime-validator](http://gtfsrealtimevalidator.transitscreen.com/) - a web-based interface to [gtfs-realtime-validator](https://github.com/CUTR-at-USF/gtfs-realtime-validator).
