...
- [Gtfs Data Manager](https://github.com/conveyal/gtfs-data-manager) and [GTFS Editor](https://github.com/conveyal/gtfs-editor).)
...
- [MapAtlas](https://mapatlas.eu) - REST API providing geocoding, directions, route optimization, matrix, isochrone, and map matching services using OpenStreetMap and proprietary data. Supports GeoJSON and MVT output.
