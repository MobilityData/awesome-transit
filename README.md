...
- [KDE Itinerary](https://apps.kde.org/itinerary/) - A cross-platform trip planning app that can locally extract ticket and reservation data directly from emails without compromising privacy.
...
- [OpenTripPlanner Android](https://github.com/CUTR-at-USF/OpenTripPlanner-for-Android/wiki) - An Android app for [OpenTripPlanner](http://www.opentripplanner.org/). No longer maintained in favor of OneBusAway.
- [OpenTripPlanner iOS](https://github.com/opentripplanner/OpenTripPlanner-iOS) - An iOS app for [OpenTripPlanner](http://www.opentripplanner.org/). No longer maintained in favor of OneBusAway.
