...
- [GTFS Editor](https://github.com/hckmseduardo/GTFS-Editor) – A (self-hosted) comprehensive multi-agency GTFS editor with real-time collaboration, offline capabilities, and map-based visualization.
