...
- [GTFS.guru](https://gtfs.guru/) - A fast, native GTFS validator with a Rust core, offering 110+ validators and JSON/HTML/SARIF reports. Ships as a desktop app, CLI, Python library, Web API, and a WebAssembly build that validates feeds locally in the browser.
